      ...
      <header className="sticky top-0 z-50 bg-white/98 backdrop-blur shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-0.5" ref={dropdownRef}>
            ...
            {/* Group About */}
            <a
              href="https://hutechc.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="ml-1 px-4 py-2.5 rounded-xl transition-all text-[14px] text-gray-600 hover:text-[#4A1D96] hover:bg-purple-50 font-semibold"
            >
              그룹 소개
            </a>
          </nav>
          ...
          <nav className="lg:hidden border-t border-gray-100 bg-white px-6 pb-8 pt-4 overflow-y-auto max-h-[calc(100vh-80px)] space-y-2">
            ...
            <div className="py-2 px-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block p-4 rounded-2xl transition-all text-gray-600 hover:bg-purple-50 font-semibold"
                onClick={() => setMobileOpen(false)}
              >
                그룹 소개
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold">
                ...
                <li><a href="https://hutechc.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">30년 정통사업</a></li>
